...
def test_instantiate_reference_mla(random_weights):
    """
...
def test_instantiate_tt_mla(random_weights, device):
    """
...
def test_instantiate_both_mla_modules(random_weights, device):
    """
...
def test_tt_mla_weight_dtypes(random_weights, device):
    """
...
def test_mla_with_both_weight_types(use_pretrained, random_weights, pretrained_weights, device):
    """
...
@pytest.mark.parametrize("use_pretrained", [False, True], ids=["random", "pretrained"])
def test_reference_and_tt_comparison(use_pretrained, random_weights, pretrained_weights, device):
    """
