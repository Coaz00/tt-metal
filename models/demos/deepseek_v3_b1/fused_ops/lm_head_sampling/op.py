...
class LMHeadSampling:
    ...
    def op(
        ...
        if enable_mtp:
            ...
            eh_subblock_k = eh_subblock_k or eh_num_tiles_k
        ...
        # h_norm_cb = 13  # [MTP] h_rmsnorm output on sender core (intermediate)
        # e_norm_cb = 14  # [MTP] e_rmsnorm output on sender core (intermediate)
        ...
        for row in range(mesh_rows):
            for col in range(mesh_cols):
                ...
                ncrisc_named_compile_time_args = [
                    ...
                    ("mcast_eh_src_num_pages", eh_num_tiles_k if enable_mtp else 0),
                ...
                trisc_named_compile_time_args = [
                    ...
                    # Both RMSNorms push to mcast_eh_src_cb; FIFO order gives [h_norm|e_norm] (see kernel comment)
                    ("rmsnorm_h_output_cb", rmsnorm_input_cb),
                    ("rmsnorm_h_num_tiles", rms_num_tiles),
                    ("mtp_h_norm_ready_semaphore", mtp_h_norm_ready_semaphore_id if enable_mtp else 0),
                    ("rmsnorm_e_input_cb", embedding_cb),
                    ("rmsnorm_e_gamma_cb", e_gamma_cb),
                    ("rmsnorm_e_output_cb", embedding_cb),
                    ("rmsnorm_e_num_tiles", e_num_tiles if enable_mtp else 0),
