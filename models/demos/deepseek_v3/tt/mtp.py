...
class MTP2D(AbstractModule):
    ...
    def prefill_model_config(cls, hf_config: PretrainedConfig, mesh_device: ttnn.MeshDevice) -> ModelPrefillConfig:
        ...
        decoder_block_cfg = MoEDecoderBlock2D.prefill_model_config(hf_config, mesh_device)
    ...
    def decode_model_config(cls, hf_config: PretrainedConfig, mesh_device: ttnn.MeshDevice) -> ModelDecodeConfig:
        ...
        decoder_block_cfg = MoEDecoderBlock2D.decode_model_config(hf_config, mesh_device)
    ...
    def create_shared_state(cls, hf_config: PretrainedConfig, mesh_device: ttnn.MeshDevice) -> ModelState:
        return {
            "decoder_block": MoEDecoderBlock2D.create_shared_state(hf_config, mesh_device),
        }
