...
import ttnn
from models.experimental.stable_diffusion_xl_base.tt.model_configs import ModelOptimisations512x512
from models.experimental.stable_diffusion_xl_base.refiner.tt.model_configs import RefinerModelOptimisationsBase


class RefinerModelOptimisations512x512(RefinerModelOptimisationsBase, ModelOptimisations512x512):
    def __init__(
        self,
        ...
        self.matmul_versions = {
            "40_cores": {
                ...
                "2D_FF2_SEQ_LEN_64": ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
                    compute_with_storage_grid_size=(8, 2),
                    in0_block_w=3,
                    per_core_M=1,
                    per_core_N=6,
    ...
    def get_matmul_config(self, matmul_path):
        ...
        if "ff.net.2" in matmul_path:
            if "mid_block" in matmul_path:
                return self.matmul_configs.get("2D_FF2_SEQ_LEN_64")
            elif "down_blocks.1" in matmul_path or "up_blocks.2" in matmul_path:
