...
run_t3000_mochi_tests() {
  ...
  export TT_DIT_CACHE_DIR="/tmp/TT_DIT_CACHE"
  FAKE_DEVICE=T3K pytest models/tt_dit/tests/models/mochi/test_vae_mochi.py -k "decoder and 1link-load_dit-small_latent or conv3d_1x1x1 or -1link-l768" --timeout=3600; fail+=$?
